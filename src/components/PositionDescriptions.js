...
class PositionDescription extends Component {
	render(){
		return(
			<div>
				<div className="control-center-operator">
				...
				<div className="counting-center-official">
				...
				<div className="delivery-collection-official">
				...
				<div className="facility-official">
				...
				<div className="precinct-official">
				...
				<div className="precinct-troubleshooter">
					<p><strong>Precinct Troubleshooter</strong>
